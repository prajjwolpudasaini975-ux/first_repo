...
#### Date of program : 19/11/2025

#### Student ID : 500773942

#### Module Code : ASB-4012
...
raw_orders_coffee <- readRDS("raw_orders_coffee.rds")
...
#exporting the dataframe to local file.
#write.csv(order,file = "D:\\Bangor University\\Courses\\Coding for Business Application\\End Project\\Code Exports\\orders.csv",row.names = FALSE)
